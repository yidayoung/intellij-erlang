...
class ErlangAtomXValue extends ErlangPrimitiveXValueBase<OtpErlangAtom> {
  public ErlangAtomXValue(OtpErlangAtom value, String name, XDebugSession session) {
  ...
  protected XValuePresentation getPresentation(@NotNull XValueNode node, @NotNull XValuePlace place) {
    return new XKeywordValuePresentation(getValue().atomValue());
  }
}
